...
export function Grading({ onNavigate }: GradingProps) {
          ...
          <Card className="p-6 bg-white/10 backdrop-blur-lg border-white/20 shadow-xl">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white mb-1">Corrigir Atividade: Pedro A.</h2>
                  <p className="text-sm text-blue-200 mb-2">Projeto PictoBlox</p>
                  <div className="flex gap-2">
                    <Badge className="bg-blue-500/20 text-blue-300 border-blue-400/30">
                      Turma 9A
                    </Badge>
                    <Badge className="bg-purple-500/20 text-purple-300 border-purple-400/30">
                      Enviado em 04/02/2026
                    </Badge>
                  </div>
                </div>
              </div>
          ...
          <Card className="p-8 bg-white/10 backdrop-blur-lg border-white/20 shadow-xl">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-white/10 rounded-2xl p-8 mb-4">
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-white mb-2">projeto_pictoblox.sb3</h3>
                <p className="text-sm text-blue-200">Arquivo enviado pelo aluno</p>
              </div>
              
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                <p className="text-sm text-blue-200 mb-2">📝 Comentários do aluno:</p>
                <p className="text-white">
                  "Desenvolvi um robô seguidor de linha usando sensores infravermelhos. 
                  O robô consegue detectar e seguir uma linha preta no chão de forma autônoma."
                </p>
              </div>
            </div>
          </Card>
